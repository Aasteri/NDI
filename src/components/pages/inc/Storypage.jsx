                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <h4 class="small font-weight-bold">National parliament voting intention (percentage) <span class="float-end">20%</span></h4>
                                ...
                                <h4 class="small font-weight-bold">Voters Database <span class="float-end">60%</span></h4>
                                <div class="progress mb-4">
                                    <div class="progress-bar" role="progressbar" style={{ width: '60%' }} aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <h4 class="small font-weight-bold">Individual Details <span class="float-end">80%</span></h4>
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-info" role="progressbar" style={{ width: '80%' }} aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <h4 class="small font-weight-bold">Polling Unit Setup <span class="float-end">Complete!</span></h4>
                                <div class="progress">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <p>Adding some quality, illustrations to your vote technic courtesy of <a target="_blank" rel="nofollow" href="https://ndi.org/nigeria">National Democratic Institute</a>,
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <p>NDI is a non-profit, non-partisan, non-governmental organization that works in partnership around the world to strengthen and safeguard democratic institutions, processes, norms and values to secure a better quality of life for all. NDI envisions a world where democracy and freedom prevail, with dignity for all.</p>
